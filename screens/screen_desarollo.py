...
screenDesarollo = ui.page_fluid(
    ...
    ui.div(
        ...
        ui.h4("Dataset"),
        ui.column(12, ui.input_file("file_desarollo", "Selección de archivo CSV o TXT. Es importante seleccionar primero el delimitador, luego el dataset.",
        ...
        ui.card(
            ui.row(
                ui.row(
                    ...
                    crear_card_con_input_seleccionador("par_ids", "Columnas identificadora:", "help_columnas_id", ui.tags.i(class_="fa fa-question-circle-o", style="font-size:24px")),
                    crear_card_con_input_numeric_2(f"par_split", "Training and Testing", "help_training_testing", ui.tags.i(class_="fa fa-question-circle-o", style="font-size:24px"), previous_values, default_value=0, min_value=0, max_value=2, step=0.01),
                    crear_card_con_input_seleccionador("par_target", "Columna Target", "help_target_col", ui.tags.i( class_="fa fa-question-circle-o", style="font-size:24px"))
                ...
                ui.row(
                    crear_card_con_input_seleccionador_V2("cols_nulos_adic", "Lista de variables y códigos de nulos", "help_nulos_adic", ui.tags.i(class_="fa fa-question-circle-o", style="font-size:24px")),
                    crear_card_con_input_numeric_2(f"par_cor_show", "Mostrar variables por alta correlación:", "help_par_cor_show", ui.tags.i(class_="fa fa-question-circle-o", style="font-size:24px"), previous_values, default_value=0, min_value=0, max_value=1, step=0.01),
                    crear_card_con_input_numeric_2(f"par_iv", "Límite para descartar variables por bajo IV", "help_iv", ui.tags.i(class_="fa fa-question-circle-o", style="font-size:24px"), previous_values, default_value=3, min_value=0.5, max_value=10, step=0.1),
                    ),
                ui.row(
